    ...
    public static void main(String[] args) {
        try {
            ...
            for (Question q : questions){
                ...
                System.out.println("choices :" + q.getOptions());
                System.out.println("correct :"+ q.getOptions().get(q.getCorrectIndex()));
                System.out.println();
            }
        }catch (Exception e) {
            System.err.println("Erreur lors du chargement du quiz" + e.getMessage());
        }
    }
}